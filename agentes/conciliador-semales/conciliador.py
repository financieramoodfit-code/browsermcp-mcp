...
def load_local():
    ...
    if 'Fecha/Hora' not in col:
        # encabezado de columna A vacio/corrupto en la planilla viva; la columna A
        # es la marca temporal (verificado: 738/744 filas con datetime valido)
        col['Fecha/Hora'] = 1
