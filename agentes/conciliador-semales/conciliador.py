...
def load_local():
    ...
    if 'Fecha/Hora' not in col and isinstance(ws.cell(row=2,column=1).value, datetime.datetime):
        col['Fecha/Hora'] = 1   # header de fecha vino en blanco en esta exportacion
