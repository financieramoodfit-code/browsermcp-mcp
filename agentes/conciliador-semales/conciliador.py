...
def load_local():
    ...
    if not str(hdr.get(1) or '').strip():
        # Encabezado de la columna A viene vacío/corrupto (solo saltos de línea)
        # en la planilla fuente, pero la columna sí contiene la Fecha/Hora.
        hdr[1] = 'Fecha/Hora'
