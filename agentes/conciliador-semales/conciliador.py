...
def load_local():
    ...
    # La col. de fecha suele venir sin encabezado util (p.ej. '\n\n'); si no
    # se encuentra 'Fecha/Hora' por nombre, se usa la columna 1 por posicion.
    fecha_col = col.get('Fecha/Hora', 1)
    for r in range(2, ws.max_row+1):
        ...
        out.append(_mk(f"H1:{r}", 'Hoja1', g('N° Remito'), g('Cliente'),
                       g('Importe'), ws.cell(row=r, column=fecha_col).value,
                       g('Estado Pago'), g('Empresa')))
