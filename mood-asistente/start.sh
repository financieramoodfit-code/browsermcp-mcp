...
cat <<'CHK'
  ...
  ⚠️  A partir de acá el asistente ENVÍA MENSAJES REALES a tus clientes sin que
      nadie los revise antes. Mirá las primeras rondas a mano (los logs quedan
      en mood-asistente/logs/) antes de dejarlo solo.
CHK
